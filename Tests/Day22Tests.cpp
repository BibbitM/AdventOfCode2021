...
on x=967..23432,y=45373..81175,z=27513..53682)--";
	...
	constexpr const char c_exampleInput3[] = R"--(on x=-5..47,y=-31..22,z=-19..33
...
TEST(Day22, CubeMapFromExampleInput2)
{
	...
	EXPECT_EQ(map.Volume(), 590'784);
}

TEST(Day22, CubeMapFromExampleInput3)
{
	CubeMap map;
	std::istringstream in(c_exampleInput3);
	...
	EXPECT_EQ(map.Volume(), 2'758'514'936'282'235);
}
